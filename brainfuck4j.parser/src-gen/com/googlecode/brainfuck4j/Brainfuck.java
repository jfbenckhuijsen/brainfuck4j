/* Generated By:JJTree&JavaCC: Do not edit this line. Brainfuck.java */
package com.googlecode.brainfuck4j;

import java.io.InputStream;

public class Brainfuck/*@bgen(jjtree)*/implements BrainfuckTreeConstants, BrainfuckConstants {/*@bgen(jjtree)*/
...
/** Root production. */
  static final public ASTStart ASTStart() throws ParseException {
...
/** Header productions. */
 ...
 /*@bgen(jjtree) ProgramHeader */
    ...
    try {
      jj_consume_token(PROGRAM_NAME_KEYWORD);
      t = jj_consume_token(PROGRAM_NAME);
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
  ...
  static final public void HeapHeader() throws ParseException {
 /*@bgen(jjtree) HeapHeader */
        HeapHeader jjtn000 = new HeapHeader(JJTHEAPHEADER);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Token t;
    try {
      jj_consume_token(HEAP_SIZE_KEYWORD);
      t = jj_consume_token(HEAP_SIZE);
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
...
/** Instruction productions. */
 ...
 /*@bgen(jjtree) UnaryExpression */
        ...
        jjtree.openNodeScope(jjtn000);Token t;
    try {
      t = jj_consume_token(INSTRUCTION_LITERAL);
          jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
  ...
  static final public void BlockExpression() throws ParseException {
  ...
  static public BrainfuckTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2080,0x2080,0x2080,};
   }

  /** Constructor with InputStream. */
  public Brainfuck(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Brainfuck(java.io.InputStream stream, String encoding) {
    ...
    token_source = new BrainfuckTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Brainfuck(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Brainfuck(BrainfuckTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(BrainfuckTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
