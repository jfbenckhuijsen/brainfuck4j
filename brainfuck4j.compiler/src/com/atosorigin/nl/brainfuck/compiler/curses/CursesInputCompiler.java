 ...
 *
 */
public class CursesInputCompiler extends InputCompiler {

	/**
	 * 
	 */
	public CursesInputCompiler() {
		super();
	}

	/* (non-Javadoc)
	 * @see com.atosorigin.nl.brainfuck.compiler.v1.InputCompiler#compile(com.atosorigin.nl.brainfuck.compiler.CompilerContext, java.lang.Object)
	 */
	@Override
	public void compile(CompilerContext ctx, Object instr) {
		...
		ObjectType inputChar = new ObjectType("jcurses.system.InputChar");
		...
		// Stack: arrayref, index -> arrayref, index, InputChar
		ctx.append(ctx.getFactory().createInvoke("jcurses.system.Toolkit", 
				"readCharacter", 
				inputChar, 
				Type.NO_ARGS, 
				Constants.INVOKESTATIC));
		// Stack: arrayRef, index, InputChar -> arrayRef, index, value
		ctx.append(ctx.getFactory().createInvoke("jcurses.system.InputChar",
				"getCode",
				Type.INT,
				Type.NO_ARGS,
